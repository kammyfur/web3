...
<head>
    ...
    <title><?= $lang == 'en' ? "Branding" : "Charte graphique" ?>  •  Minteck Projects™</title>
...
<body class="page">
    ...
    <h1 class="high"><?= $lang == 'en' ? "Branding" : "Charte graphique" ?><span class="tseparator"> </span><a class="editLink" href="/tools/editBranding"><?= $lang == 'en' ? "edit" : "modifier" ?></a></h1>
    <?= file_get_contents($_SERVER['DOCUMENT_ROOT'] . "/branding/markup.xhtml") ?>

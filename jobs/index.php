...
?>
 ...
 <?php include_once $_SERVER['DOCUMENT_ROOT'] . "/tools/logIp.php"; logIP() ?>
...
<head>
    ...
    <title><?= $lang == 'en' ? "Jobs" : "Recrutement" ?>  •  Minteck Projects™</title>
...
<body class="specialpage">
    ...
    <iframe id="jobform" class="jobform" src="https://bit.ly/2Uw5cjt">Désolé, votre navigateur ne supporte pas la manière dont nous affichons cet élément...</iframe>

...
<head>
    ...
    <title>Minteck Projects™  •  <?= $lang == 'en' ? "For a free Internet" : "Pour un Internet libre" ?></title>
...
<body class="page">
    ...
    <div class="main-after"></div>
        <?= $lang == "en" ? 'We are on the same side of Mozilla: <i> "Internet is a common property, respect it!" </i> <br> Minteck Projects respects the privacy of its users, while offering quality services. Like what, the violation of the privacy does not make it possible to improve the quality of its services! <br> <br> We have the following qualities and advantages: <ul>
        <li> We respect the privacy of our users. </li>
        <li> We are very transparent about the use of user data. </li>
        <li> We never favor quantity over quality. </li>
        <li> We are very much at the service of our community, and very attentive. </ li>
        <li> For most of our services, we give you access to the source code of these services. </li>
        <li> We are decentralized, it means that wherever you are, you can work with us. </li>
    </ul> <br> And unfortunately, like everyone else, we "have" the following disadvantages: <ul>
            <li> When we\'re not active, it\'s for a long time. </li>
            <li> Our servers are reliable, but not enough for our taste. </li>
            <li> We only communicate when French or English. </li>
            <li> Our programs are very few multi-platforms, often a program dedicated to a platform ... </li>
            <li> We are pretty vague about our real identity, for reasons of personal security. </li>
            <li> We tend to ask you more information than we really need, which can put some users in a difficult situation. </li>
        </ul>
        <center> <table>
            <Tr>
                <td class="m-pres-security" id="security">
                    <center> <img src="/images/m-pres-security.png" alt="Security" class="m-pres-img"> <span class="m-pres-separator1"> </span> <span class="m-pres-title"> Safety and Integrity </span> </center> <br class="m-pres-separator2"> <center> We take the utmost care that our users safe using our services, and that our services are reliable and stable as much as possible ... </center>
                </td>
                <td class="m-pres-advertising" id="advertising">
                    <center> <img src="/images/m-pres-advertising.png" alt="Advertising" class="m-pres-img"> <span class="m-pres-separator1"> </span> <span class="m-pres-title"> Advertising and Sharing </span> </center> <br class="m-pres-separator2"> <center> Sharing, speaking and promoting are essential elements for the proper functioning of our products, but we still know how to manage them properly so as not to be too intrusive as possible. </center>
                </td>
                <td class="m-pres-freedom" id="freedom">
                    <center> <img src="/images/m-pres-freedom.png" alt="The Web is Freedom Slogan" class="m-pres-img"> <span class="m-pres-separator1"> </span> <span class="m-pres-title"> <i> "The Web is Freedom" </i> </span> </center> <br class="m-pres-separator2"> <center> On the Internet, you all have the right to be independent! That\'s why Minteck Projects asks you for an account for each of its services, because we suspect that you will not use them all ... So you are never dependent on our services! </Center>
                    </td>
            </tr>
        </table> </center>
        ...
        <hr>
        <?= $lang == "en" ? '<h1> Who are we? </h1>
        Minteck Projects is a non-profit organization offering a variety of computer and electronic services. We mainly offer services on the Internet, accessible by all.
        <h2> Where are we? </h2>
        Our servers are spread all over the world, but we try to respect French legislation. So you will have no problem!
        <h2> Since when are we here? </h2>
        We are here since September 2018. <br>
        We were founded to recover the project Chat\'Max (which does not exist today unfortunately...), so that it remains only 4 months with us ... <br>
        In January 2019, we founded Minteck Projects Private, a private and personal company for Minteck Projects management staff.
        <h2> Who is Minteck? </h2>
        Minteck is probably the one who is writing to you right now ^^ ... Minteck is the CEO of Minteck Projects from the beginning. It is also he who set up the partnership with Numit ... He gave all the ideas and advance alone in his business since all this time ... <i> (I must not hide that it in fact a lot of work to get nothing in return ... You have to be really generous to agree to work in such conditions ... but no, I\'m kidding!) </i>
        <h3> Why do not we know more about him? </h3>
        Unfortunately, he does not want to introduce himself, and still prefers to keep these distances with the Internet. It seeks to keep private all personal information, but can still talk with you, do not worry (good after maybe not if you do not look nice)...
        <h1> Our slogan </h1>
        Our current slogan is <i> "The Web is Freedom" </i>. It was chosen as a slogan because it represents what we are trying to sell: services where you are free to be dependent or not, to use them or not... Unlike other companies offering similar services, we respect enormously the laws in force in France, and in several other countries...' : '<h1>Qui sommes nous ?</h1>
        ...
        Nous sommes ici depuis septembre 2018.<br>
        Nous fûmes fondés pour récupérer le projet Chat\'Max (qui n\'existe plus aujourd\'hui malheureusement...), pour qu\'il ne reste que 4 mois chez nous...<br>
